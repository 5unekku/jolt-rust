...
use crate::{
    shape::create_shape_inner, shape::SubShape, FromJolt, IntoJolt, Quat, Ref, RefConst, Vec3,
};
...
impl BoxShapeSettings {
    pub fn new(half_extent: Vec3, convex_radius: f32) -> Self {
        Self {
            raw: JPC_BoxShapeSettings {
                HalfExtent: half_extent.into_jolt(),
                ConvexRadius: convex_radius,
                ..Default::default()
            },
            material: None,
        }
    ...
    pub fn half_extent(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.HalfExtent)
    }
    pub fn set_half_extent(&mut self, v: Vec3) {
        self.raw.HalfExtent = v.into_jolt();
    }
    pub fn convex_radius(&self) -> f32 {
        self.raw.ConvexRadius
    }
    pub fn set_convex_radius(&mut self, v: f32) {
        self.raw.ConvexRadius = v;
    }
    ...
    pub fn material(&self) -> Option<&RefConst<JPC_PhysicsMaterial>> {
...
impl CapsuleShapeSettings {
    ...
    pub fn half_height_of_cylinder(&self) -> f32 {
        self.raw.HalfHeightOfCylinder
    }
    pub fn set_half_height_of_cylinder(&mut self, v: f32) {
        self.raw.HalfHeightOfCylinder = v;
    }
    pub fn radius(&self) -> f32 {
        self.raw.Radius
    }
...
impl CylinderShapeSettings {
    ...
    pub fn set_half_height(&mut self, v: f32) {
        self.raw.HalfHeight = v;
    }
    pub fn radius(&self) -> f32 {
        self.raw.Radius
    }
...
impl TriangleShapeSettings {
    ...
    pub fn v1(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.V1)
    }
    pub fn set_v1(&mut self, v: Vec3) {
        self.raw.V1 = v.into_jolt();
    }
    pub fn v2(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.V2)
    }
    pub fn set_v2(&mut self, v: Vec3) {
        self.raw.V2 = v.into_jolt();
    }
    pub fn v3(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.V3)
    }
    pub fn set_v3(&mut self, v: Vec3) {
        self.raw.V3 = v.into_jolt();
    }
    pub fn convex_radius(&self) -> f32 {
        self.raw.ConvexRadius
    }
...
impl PlaneShapeSettings {
    ...
    pub fn normal(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.Normal)
    }
    pub fn set_normal(&mut self, v: Vec3) {
        self.raw.Normal = v.into_jolt();
    }
    ...
    pub fn set_half_extent(&mut self, v: f32) {
        self.raw.HalfExtent = v;
    }
    pub fn user_data(&self) -> u64 {
        self.raw.UserData
    }
...
impl TaperedCapsuleShapeSettings {
    pub fn new(half_height: f32, top_radius: f32, bottom_radius: f32) -> Self {
        Self {
            raw: JPC_TaperedCapsuleShapeSettings {
                HalfHeightOfTaperedCylinder: half_height,
    ...
    pub fn half_height_of_tapered_cylinder(&self) -> f32 {
        self.raw.HalfHeightOfTaperedCylinder
    }
    pub fn set_half_height_of_tapered_cylinder(&mut self, v: f32) {
        self.raw.HalfHeightOfTaperedCylinder = v;
    }
    pub fn top_radius(&self) -> f32 {
        self.raw.TopRadius
    }
    pub fn set_top_radius(&mut self, v: f32) {
        self.raw.TopRadius = v;
    }
    pub fn bottom_radius(&self) -> f32 {
        self.raw.BottomRadius
    }
    pub fn set_bottom_radius(&mut self, v: f32) {
        self.raw.BottomRadius = v;
    }
    pub fn density(&self) -> f32 {
        self.raw.Density
    }
    ...
    pub fn create(&self) -> Result<RefConst<JPC_Shape>, String> {
        create_shape_inner(|s, e| unsafe {
            JPC_TaperedCapsuleShapeSettings_Create(&self.raw, s, e)
        })
    }
}
...
impl TaperedCylinderShapeSettings {
    ...
    pub fn create(&self) -> Result<RefConst<JPC_Shape>, String> {
        create_shape_inner(|s, e| unsafe {
            JPC_TaperedCylinderShapeSettings_Create(&self.raw, s, e)
        })
    }
}
...
impl EmptyShapeSettings {
    pub fn new(center_of_mass: Vec3) -> Self {
        Self {
            raw: JPC_EmptyShapeSettings {
                CenterOfMass: center_of_mass.into_jolt(),
                ..Default::default()
            },
        }
    }
    pub fn center_of_mass(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.CenterOfMass)
    }
    pub fn set_center_of_mass(&mut self, v: Vec3) {
        self.raw.CenterOfMass = v.into_jolt();
    }
    pub fn user_data(&self) -> u64 {
        self.raw.UserData
    }
...
impl ConvexHullShapeSettings {
    pub fn new(points: &[Vec3]) -> Self {
        let mut this = Self {
            raw: Default::default(),
            points: points.iter().copied().map(IntoJolt::into_jolt).collect(),
            material: None,
        };
    ...
    pub fn max_convex_radius(&self) -> f32 {
        self.raw.MaxConvexRadius
    }
    pub fn set_max_convex_radius(&mut self, v: f32) {
        self.raw.MaxConvexRadius = v;
    }
    pub fn max_error_convex_radius(&self) -> f32 {
        self.raw.MaxErrorConvexRadius
    }
    pub fn set_max_error_convex_radius(&mut self, v: f32) {
        self.raw.MaxErrorConvexRadius = v;
    }
    pub fn hull_tolerance(&self) -> f32 {
        self.raw.HullTolerance
    }
    pub fn set_hull_tolerance(&mut self, v: f32) {
        self.raw.HullTolerance = v;
    }
    pub fn density(&self) -> f32 {
        self.raw.Density
    }
    ...
    pub fn create(&self) -> Result<RefConst<JPC_Shape>, String> {
        let raw = JPC_ConvexHullShapeSettings {
            Points: self.points.as_ptr(),
            PointsLen: self.points.len(),
            ..self.raw
        };
...
impl HeightFieldShapeSettings {
    ...
    pub fn offset(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.Offset)
    }
    pub fn set_offset(&mut self, v: Vec3) {
        self.raw.Offset = v.into_jolt();
    }
    pub fn scale(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.Scale)
    }
    pub fn set_scale(&mut self, v: Vec3) {
        self.raw.Scale = v.into_jolt();
    }
    pub fn sample_count(&self) -> u32 {
        self.raw.SampleCount
    }
    pub fn min_height_value(&self) -> f32 {
        self.raw.MinHeightValue
    }
    pub fn set_min_height_value(&mut self, v: f32) {
        self.raw.MinHeightValue = v;
    }
    pub fn max_height_value(&self) -> f32 {
        self.raw.MaxHeightValue
    }
    pub fn set_max_height_value(&mut self, v: f32) {
        self.raw.MaxHeightValue = v;
    }
    pub fn block_size(&self) -> u32 {
        self.raw.BlockSize
    }
    pub fn set_block_size(&mut self, v: u32) {
        self.raw.BlockSize = v;
    }
    pub fn bits_per_sample(&self) -> u32 {
        self.raw.BitsPerSample
    }
    pub fn set_bits_per_sample(&mut self, v: u32) {
        self.raw.BitsPerSample = v;
    }
    pub fn active_edge_cos_threshold_angle(&self) -> f32 {
        self.raw.ActiveEdgeCosThresholdAngle
    }
    pub fn set_active_edge_cos_threshold_angle(&mut self, v: f32) {
        self.raw.ActiveEdgeCosThresholdAngle = v;
    }
    pub fn set_material_indices(&mut self, indices: &[u8]) {
        self.material_indices = indices.to_vec();
    }
    pub fn user_data(&self) -> u64 {
        self.raw.UserData
    }
...
impl StaticCompoundShapeSettings {
    ...
    pub fn create(&self) -> Result<RefConst<JPC_Shape>, String> {
        let raw_sub: Vec<JPC_SubShapeSettings> = self
            .sub_shapes
            .iter()
        ...
        let settings = JPC_StaticCompoundShapeSettings {
            SubShapes: raw_sub.as_ptr(),
            SubShapesLen: raw_sub.len(),
            UserData: self.user_data,
        };
        create_shape_inner(|s, e| unsafe {
            JPC_StaticCompoundShapeSettings_Create(&settings, s, e)
        })
    }
}
...
impl MutableCompoundShapeSettings {
    ...
    pub fn create(&self) -> Result<Ref<JPC_MutableCompoundShape>, String> {
        ...
        let ok =
            unsafe { JPC_MutableCompoundShapeSettings_Create(&settings, &mut shape, &mut error) };
        if ok {
...
impl RotatedTranslatedShapeSettings {
    pub fn new(inner: &RefConst<JPC_Shape>, position: Vec3, rotation: Quat) -> Self {
        Self {
            raw: JPC_RotatedTranslatedShapeSettings {
                InnerShape: inner.get(),
                Position: position.into_jolt(),
                Rotation: rotation.into_jolt(),
                ..Default::default()
            },
            _inner: inner.clone(),
        }
    ...
    pub fn position(&self) -> Vec3 {
        Vec3::from_jolt(self.raw.Position)
    }
    ...
    pub fn create(&self) -> Result<RefConst<JPC_Shape>, String> {
        create_shape_inner(|s, e| unsafe {
            JPC_RotatedTranslatedShapeSettings_Create(&self.raw, s, e)
        })
    }
}
...
impl OffsetCenterOfMassShapeSettings {
    ...
    pub fn create(&self) -> Result<RefConst<JPC_Shape>, String> {
        create_shape_inner(|s, e| unsafe {
            JPC_OffsetCenterOfMassShapeSettings_Create(&self.raw, s, e)
        })
    }
}
